...
public class ApplicationUtils {
    ...
    /**
     * 查看两者之间的关注
     * @param play_user_id    作者、另外玩家id
     * @param user_id          本人id
     * @param tFriendService   朋友关系service 层
     * @return
     */
    public static String GetRelation(Integer play_user_id,Integer user_id,TFriendService tFriendService){

        String Flag="0";
        String Flag2="0";
        String Follow="0";
        //查找本窝窝作者的粉丝
        List<TFriend> tFriendList=tFriendService.getFriendByUserId(play_user_id);
        ...
        //查看本玩家粉丝
        List<TFriend> tFriendList2=tFriendService.getFriendByUserId(user_id);
        for(TFriend f:tFriendList2){
            if(f.getFriendId().equals(play_user_id)){
                Flag2="1";
                break;
            }
        }
