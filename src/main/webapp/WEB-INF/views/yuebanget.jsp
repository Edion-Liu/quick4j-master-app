        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="page-title">
                        约伴信息查询 <small> <a href="rest/page/allinformation">设备状态查询</a></small>
                    </h3>
                ...
                <div class="modal-dialog modal-wide" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <label  id="myModalLabel"  style="font-size: larger;font-weight: bold ;">约伴信息详情</label>
                        </div>
                        <div class="modal-body">

                            <div class="form-group">
                                <label style="font-size: large;font-weight: bold ;">约伴描述</label>
                                <p id="yuebandescription" ></p>

                            </div>

                            <div class="form-group">
                                <label style="font-size: large;font-weight: bold ;" >约伴地址</label>
                                <p id="yuebancurrentadress" ></p>

                            </div>

                            <div class="form-group">
                                <label style="font-size: large;font-weight: bold ;" >约伴发布时间</label>
                            ...
                            <div class="form-group">
                                <label style="font-size: large;font-weight: bold ;" >约伴图片</label>
                                <ul id="jq22">
...
<script>
 ...
 /*  var serverurl="http://139.224.47.78:9010/user/testController";*/
    ...
    var serverurl="<%=basePath%>"+"/rest/manage/yueban/yuebangetInfromation";
          ...
          //      dataField: "rows",//服务端返回数据键值 就是说记录放的键值是rows，分页时使用总记录数的键值为total
           ...
           //     showPaginationSwitch:"true",//是否显示 数据条数选择框
                ...
                columns: [
                    ...
                    {
                        field: 'yuebandescription',
                        title: '约伴描述',
                        align: 'center'
                    },
                    {
                        field: 'yuebanpublishtime',
                        title: '约伴信息发布时间',
                        align: 'center'
                    },
                    {
    ...
    function addElementImg(obj,imgurl) {
...
//                    alert(JSON.stringify(result.status));                 //执行成功
//                    alert(JSON.stringify(result.yuebanimage));                 //执行成功

                    //清除已生成元素
                    var ul = document.getElementById("jq22");
                    ...
                    for(var i = 0; i < result.yuebanimage.length; i++)
                    {
                       // alert(result.yuebanimage[i].yuebanid + " " + result.yuebanimage[i].imageurl);
                        addElementImg("jq22",result.yuebanimage[i].imageurl);
            ...
            $("#myModalLabel").text("序号："+row.id +" "+"约伴信息详情");
            $("#yuebanpublishtime").text(row.yuebanpublishtime);
            $("#yuebancurrentadress").text(row.yuebancurrentadress);
            $("#yuebandescription").text(row.yuebandescription);
            $('#myModal').modal();
